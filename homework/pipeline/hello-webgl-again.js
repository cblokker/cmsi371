...
(function (canvas) {
    ...
    for (i = -2.1; i < 10; i += 0.8) {
        xPosition.push(i);
    }

    honeyCombGenerator = function () {
        var tx,
            ty,
            tz,
            txMax,
        ...
        for (tx = -12, txMax = 12; tx <= txMax; tx += 0.6) {
            for (ty = -12, tyMax = 12; ty < tyMax; ty += 0.55) {
                children.push({
                    color: {r: 1, g: 1, b: 0.0},
